...
\begin{frame}
\frametitle{JER vs Eta: 85 $<$ pTavg $<$ 115}
\begin{columns}
\begin{column}{.3\textwidth}
\center{Pure Pythia8}
\includegraphics[width=4cm, height=3cm]{MCvsData_Pythia/85pTavg115_MCvsData.pdf}
\end{column}
\begin{column}{.3\textwidth}
\center{Powheg+Pythia8}
\includegraphics[width=4cm, height=3cm]{MCvsData_PowhegPythia/85pTavg115_MCvsData.pdf}
\end{column}
\begin{column}{.3\textwidth}
\center{Sherpa}
\includegraphics[width=4cm, height=3cm]{MCvsData_Sherpa/85pTavg115_MCvsData.pdf}
\end{column}
\end{columns}
\begin{itemize}
\item Pure Pythia8 and Sherpa have the a larger Truth resolution than Reco.
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{\small{JER vs Eta: 85 $<$ pTavg $<$ 115 : Pythia8 EM+JES fits}}
\center{\includegraphics[width=9cm, height=6.5cm]{85to115PEMTopoFits1.pdf}}
\end{frame}

\begin{frame}
\frametitle{\small{JER vs Eta: 85 $<$ pTavg $<$ 115 : Pythia8 EM+JES fits}}
\center{\includegraphics[width=9cm, height=6.5cm]{85to115PEMTopoFits2.pdf}}
\end{frame}

\begin{frame}
\frametitle{\small{JER vs Eta: 85 $<$ pTavg $<$ 115 : Pythia8 EM+JES fits}}
\center{\includegraphics[width=9cm, height=5cm]{85to115PEMTopoFits3.pdf}}
\end{frame}

\begin{frame}
\frametitle{\small{JER vs Eta: 85 $<$ pTavg $<$ 115 : Pythia8 Truth fits}}
\center{\includegraphics[width=9cm, height=6.5cm]{85to115PTruthFits1.pdf}}
\end{frame}

\begin{frame}
\frametitle{\small{JER vs Eta: 85 $<$ pTavg $<$ 115 : Pythia8 Truth fits}}
\center{\includegraphics[width=9cm, height=6.5cm]{85to115PTruthFits2.pdf}}
\end{frame}

\begin{frame}
\frametitle{\small{JER vs Eta: 85 $<$ pTavg $<$ 115 : Pythia8 Truth fits}}
\center{\includegraphics[width=9cm, height=5cm]{85to115PTruthFits3.pdf}}
\end{frame}

\begin{frame}
\frametitle{Pythia8: Problematic bins}
\begin{columns}
\begin{column}{.4\textwidth}
\includegraphics[width=4cm, height=3cm]{MCvsData_Pythia/115pTavg145_MCvsData.pdf}
\newline
\includegraphics[width=4cm, height=3cm]{MCvsData_Pythia/145pTavg175_MCvsData.pdf}
\end{column}
\begin{column}{.4\textwidth}
\includegraphics[width=4cm, height=3cm]{MCvsData_Pythia/220pTavg270_MCvsData.pdf}
\newline
\includegraphics[width=4cm, height=3cm]{MCvsData_Pythia/270pTavg330_MCvsData.pdf}
\end{column}
\end{columns}
\end{frame}
