...
int plotVBFDMresults_ConstantDimension(TString variable="", TString PS="", TString Dimension="", TString Norm="") {
  ...
  gSystem->Exec("mkdir -p Figures/"+Dimension+"/"+Norm+"");
  ...
  //  TString mass[4] = {"1", "10", "100", "1000"};

  TFile* file_Mass01 = new TFile("~/Documents/Rivet_Analyses/MC_VBFDM/"""+Dimension+"""/Mass.1/"+Norm+"/Rivet.root", "READ");
  file_Mass01->cd("MC_VBFDM_"+Norm+"");
  TH1F* Mass01 = (TH1F*)gDirectory->Get(""+variable+"_PS_"+PS+""); 
  ...
  TH1F* Mass1 = (TH1F*)gDirectory->Get(""+variable+"_PS_"+PS+"");
  ...
  */
  ...
  Mass01->SetLineColor(Mass01_line_color);Mass01->SetLineStyle(Mass01_line_style);Mass01->SetLineWidth(Mass01_line_width);Mass01->SetFillColor(Mass01_fill_color);
  Mass01->SetFillStyle(Mass01_fill_style);Mass01->SetMarkerColor(Mass01_line_color);Mass01->SetMarkerStyle(Mass01_marker_style);Mass01->SetMarkerSize(Mass01_marker_size);
  ...
  */
  ...
  leg_main->AddEntry(Mass01,"DM Mass 0.1GeV","PL");
  ...
  /*
    ...
    if (Dimension=="Higgs"){
      TH1F* M1_ratio = (TH1F*)Mass1->Clone("M1_ratio");
