...
int statisticsTest(TString variable="", TString PS="", TString Dimension="", TString StatOption=""){
  ...
  TPad* mainPad = new TPad("mainPad","", 0.03, 0.15, 0.48, 0.99); mainPad->Draw();
  ...
  mainPad->cd(); statHist->Draw("TEXT"); statHist->GetXaxis()->SetTitle("DM mass (GeV)"); statHist->GetYaxis()->SetTitle("EFT Scale"); statHist->GetYaxis()->SetTitleOffset(2.1);
