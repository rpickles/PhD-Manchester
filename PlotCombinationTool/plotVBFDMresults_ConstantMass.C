...
int plotVBFDMresults_ConstantMass(TString variable="", TString PS="", TString Mass="", TString Norm="") {
  ...
  gSystem->Exec("mkdir -p Figures/"+Mass+"/"+Norm+"/NOBKG/");
  ...
  TFile* file_Higgs750 = new TFile("~/Documents/Rivet_Analyses/MC_VBFDM/Higgs750/"""+Mass+"""/"""+Norm+"""/Rivet.root", "READ");
  file_Higgs750->cd("MC_VBFDM_"+Norm+"");
  TH1F* Higgs750 = (TH1F*)gDirectory->Get(""+variable+"_PS_"+PS+"");
  ...
  TH1F* EWK_and_fifthQCD = (TH1F*)gDirectory->Get(""+variable+"_PS_"+PS+"");
  ...
  TH1F* cRatio = (TH1F*)EWK_and_fifthQCD->Clone("cRatio");
  cRatio->Sumw2();
  cRatio->Divide(zmumu);


  //Creating the canvas for the acutal plot
  TCanvas *canv;
  ...
  TPad *mainPad;
  mainPad = new TPad("mainPad","", 0.01, 0.01, 0.99, 0.99);
  mainPad->Draw();
  mainPad->cd();
...
// }
  ...
  if (Norm == "Absolute"){
    ...
    leg_main->AddEntry(D5a,"DM D5a ","PL");
    leg_main->AddEntry(D5b,"DM D5b ","PL");
    leg_main->AddEntry(D5c,"DM D5c ","PL");
    leg_main->AddEntry(D5d,"DM D5d ","PL");
    leg_main->AddEntry(D6a,"DM D6a ","PL");
    leg_main->AddEntry(D6b,"DM D6b ","PL");
    leg_main->AddEntry(D7a,"DM D7a ","PL");
    leg_main->AddEntry(D7b,"DM D7b ","PL");
    leg_main->AddEntry(D7c,"DM D7c ","PL");
    leg_main->AddEntry(D7d,"DM D7d ","PL");
  }
  leg_main->AddEntry(Higgs,"Higgs DM Portal","PL");
  //leg_main->AddEntry(Higgs,"750GeV Higgs DM Portal","PL");
  ...
  gPad->RedrawAxis();canv->Print("Figures/"+Mass+"/"+Norm+"/NOBKG/"+Mass+"_"+variable+"_PS_"+PS+".pdf");
  gPad->RedrawAxis();canv->Print("Figures/"+Mass+"/"+Norm+"/NOBKG/"+Mass+"_"+variable+"_PS_"+PS+".png");
  gPad->RedrawAxis();canv->Print("Figures/"+Mass+"/"+Norm+"/NOBKG/"+Mass+"_"+variable+"_PS_"+PS+".eps");
