...
namespace Rivet {
  ...
  class MC_VBFDM_Normalised : public Analysis {
  public:

    /// Constructor
    MC_VBFDM_Normalised()
      : Analysis("MC_VBFDM_Normalised")
    {   }
   ...
   public:
	...
	const FinalState fs;
        ...
        ZFinder zfinder_mu(fs, Cuts::abseta < 4.5 && Cuts::pT > 0*GeV, PID::MUON, 66*GeV, 116*GeV, 0.1, ZFinder::CLUSTERNODECAY);
	...
	//Need to input bins : const int nbinMjj = 10;
	//	Double_t binsMjj[nbinMjj] = {250.,300.,400.,500.,600.,800.,1000.,1500.,2000.,4000.};
	//Mjj	
    ...
    void finalize() {
      ...
      scale(_hist_Mjj_PS_VBFZ_Baseline, factor);
      scale(_hist_Jet1PT_PS_VBFZ_Baseline, factor);
      scale(_hist_Jet2PT_PS_VBFZ_Baseline, factor);
      scale(_hist_NumJets_PS_VBFZ_Baseline, factor);
      scale(_hist_Jet1Eta_PS_VBFZ_Baseline, factor);
      scale(_hist_Jet2Eta_PS_VBFZ_Baseline, factor);
      scale(_hist_DeltaEta_PS_VBFZ_Baseline, factor);
      scale(_hist_DeltaPhi_PS_VBFZ_Baseline, factor);
      scale(_hist_met_PS_VBFZ_Baseline, factor);

      scale(_hist_Mjj_PS_VBFZ_HighMass, factor);
      scale(_hist_Jet1PT_PS_VBFZ_HighMass, factor);
      scale(_hist_Jet2PT_PS_VBFZ_HighMass, factor);
      scale(_hist_NumJets_PS_VBFZ_HighMass, factor);
      scale(_hist_Jet1Eta_PS_VBFZ_HighMass, factor);
      scale(_hist_Jet2Eta_PS_VBFZ_HighMass, factor);
      scale(_hist_DeltaEta_PS_VBFZ_HighMass, factor);
      scale(_hist_DeltaPhi_PS_VBFZ_HighMass, factor);
      scale(_hist_met_PS_VBFZ_HighMass, factor);

      scale(_hist_Mjj_PS_VBFZ_Search, factor);
      scale(_hist_Jet1PT_PS_VBFZ_Search, factor);
      scale(_hist_Jet2PT_PS_VBFZ_Search, factor);
      scale(_hist_NumJets_PS_VBFZ_Search, factor);
      scale(_hist_Jet1Eta_PS_VBFZ_Search, factor);
      scale(_hist_Jet2Eta_PS_VBFZ_Search, factor);
      scale(_hist_DeltaEta_PS_VBFZ_Search, factor);
      scale(_hist_DeltaPhi_PS_VBFZ_Search, factor);
      scale(_hist_met_PS_VBFZ_Search, factor);

      scale(_hist_Mjj_PS_VBFDM, factor);
      scale(_hist_Jet1PT_PS_VBFDM, factor);
      scale(_hist_Jet2PT_PS_VBFDM, factor);
      scale(_hist_NumJets_PS_VBFDM, factor);
      scale(_hist_Jet1Eta_PS_VBFDM, factor);
      scale(_hist_Jet2Eta_PS_VBFDM, factor);
      scale(_hist_DeltaEta_PS_VBFDM, factor);
      scale(_hist_DeltaPhi_PS_VBFDM, factor);
      scale(_hist_met_PS_VBFDM, factor);

      scale(_hist_Mjj_PS_VBFDM_100, factor);
      scale(_hist_Jet1PT_PS_VBFDM_100, factor);
      scale(_hist_Jet2PT_PS_VBFDM_100, factor);
      scale(_hist_NumJets_PS_VBFDM_100, factor);
      scale(_hist_Jet1Eta_PS_VBFDM_100, factor);
      scale(_hist_Jet2Eta_PS_VBFDM_100, factor);
      scale(_hist_DeltaEta_PS_VBFDM_100, factor);
      scale(_hist_DeltaPhi_PS_VBFDM_100, factor);
      scale(_hist_met_PS_VBFDM_100, factor);

      scale(_hist_Mjj_PS_Monojet, factor);
      scale(_hist_Jet1PT_PS_Monojet, factor);
      scale(_hist_Jet2PT_PS_Monojet, factor);
      scale(_hist_NumJets_PS_Monojet, factor);
      scale(_hist_Jet1Eta_PS_Monojet, factor);
      scale(_hist_Jet2Eta_PS_Monojet, factor);
      scale(_hist_DeltaEta_PS_Monojet, factor);
      scale(_hist_DeltaPhi_PS_Monojet, factor);
      scale(_hist_met_PS_Monojet, factor);

      scale(_hist_Mjj_PS_Monojet_HighPt, factor);
      scale(_hist_Jet1PT_PS_Monojet_HighPt, factor);
      scale(_hist_Jet2PT_PS_Monojet_HighPt, factor);
      scale(_hist_NumJets_PS_Monojet_HighPt, factor);
      scale(_hist_Jet1Eta_PS_Monojet_HighPt, factor);
      scale(_hist_Jet2Eta_PS_Monojet_HighPt, factor);
      scale(_hist_DeltaEta_PS_Monojet_HighPt, factor);
      scale(_hist_DeltaPhi_PS_Monojet_HighPt, factor);
      scale(_hist_met_PS_Monojet_HighPt, factor);

      scale(_hist_Mjj_PS_VBFDM_OR_Monojet, factor);
      scale(_hist_Jet1PT_PS_VBFDM_OR_Monojet, factor);
      scale(_hist_Jet2PT_PS_VBFDM_OR_Monojet, factor);
      scale(_hist_NumJets_PS_VBFDM_OR_Monojet, factor);
      scale(_hist_Jet1Eta_PS_VBFDM_OR_Monojet, factor);
      scale(_hist_Jet2Eta_PS_VBFDM_OR_Monojet, factor);
      scale(_hist_DeltaEta_PS_VBFDM_OR_Monojet, factor);
      scale(_hist_DeltaPhi_PS_VBFDM_OR_Monojet, factor);
      scale(_hist_met_PS_VBFDM_OR_Monojet, factor);

      scale(_hist_Mjj_PS_VBFDM_OR_Monojet_HighPt, factor);
      scale(_hist_Jet1PT_PS_VBFDM_OR_Monojet_HighPt, factor);
      scale(_hist_Jet2PT_PS_VBFDM_OR_Monojet_HighPt, factor);
      scale(_hist_NumJets_PS_VBFDM_OR_Monojet_HighPt, factor);
      scale(_hist_Jet1Eta_PS_VBFDM_OR_Monojet_HighPt, factor);
      scale(_hist_Jet2Eta_PS_VBFDM_OR_Monojet_HighPt, factor);
      scale(_hist_DeltaEta_PS_VBFDM_OR_Monojet_HighPt, factor);
      scale(_hist_DeltaPhi_PS_VBFDM_OR_Monojet_HighPt, factor);
      scale(_hist_met_PS_VBFDM_OR_Monojet_HighPt, factor);
      ...
      normalize(_hist_Mjj_PS_VBFDM_100);
      normalize(_hist_Jet1PT_PS_VBFDM_100);
      normalize(_hist_Jet2PT_PS_VBFDM_100);
      normalize(_hist_NumJets_PS_VBFDM_100);
      normalize(_hist_Jet1Eta_PS_VBFDM_100);
      normalize(_hist_Jet2Eta_PS_VBFDM_100);
      normalize(_hist_DeltaEta_PS_VBFDM_100);
      normalize(_hist_DeltaPhi_PS_VBFDM_100);
      normalize(_hist_met_PS_VBFDM_100);
      ...
      //normalize(_hist_MjjvsDeltaEta_PS_VBFDM_OR_Monojet);
  ...
  DECLARE_RIVET_PLUGIN(MC_VBFDM_Normalised);
